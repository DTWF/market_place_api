...
RSpec.describe Product, type: :model do
  ...
  describe ".filter_by_title" do
    ...
    context "when a TV title pattern is set" do
  ...
  describe ".above_or_equal_to_price" do
    ...
    it "returns the products that are above or equal to given price" do
  ...
  describe ".below_or_equal_to_price" do
    ...
    it "returns the products that are below or equal to price" do
  ...
  describe ".recent" do
    ...
    it "returns the most recent updated records" do
